...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<%=request.getContextPath()%>/trang-chu" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<%=request.getContextPath()%>/sinh-vien" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<%=request.getContextPath()%>/mon-hoc" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Môn Học</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<%=request.getContextPath()%>/the-loai" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thể Loại</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<%=request.getContextPath()%>/tin-chi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tín Chỉ</p>
                </a>
              </li>
